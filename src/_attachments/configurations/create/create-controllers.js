(function (window, angular, console) {
    'use strict';
    angular.module('myApp.controllers').controller('configurations-create', ['$scope', '$rootScope', '$http', '$stateParams', '$state', '$upload',
        function ($scope, $rootScope, $http, $stateParams, $state, $upload) {
            var file;
            ...
            $scope.submit = function (form) {
                ...
                if (form.$valid && !$scope.imageerror) {
                    $http.post('/couchdb/' + $rootScope.appID + '-' + $stateParams.organization, $scope.configuration).
